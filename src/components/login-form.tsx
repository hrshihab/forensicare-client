...
//   const [username, setUsername] = useState("admin") // Auto-filled demo username
//   const [password, setPassword] = useState("password1") // Auto-filled demo password
...
//         // Let the userLogin service handle the redirect
//         // The service will redirect based on user role
//       }
